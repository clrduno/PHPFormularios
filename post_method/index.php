      ...
      <div class="medium-12 large-12 columns">
        ...
        <form method="Post">
          <div class="medium-4  columns">
            <label>Title</label>
            <select name="title">
              <option value="1" <?php echo(($title=="1") ? "selected" : "") ?> >Mr.</option>
              <option value="2" <?php echo(($title=="2") ? "selected" : "") ?> >Ms.</option>
              <option value="3" <?php echo(($title=="3") ? "selected" : "") ?> >Mrs.</option>
              <option value="4" <?php echo(($title=="4") ? "selected" : "") ?> >Dr.</option>
            </select>
          </div>
          <div class="medium-4  columns">
            <label>Name</label>
